<template> 
  <div id="warningModal" class="feeWarning">
    <div align="right" class="mediumMarginLeft feeWarning">
      <ion-button id="closeAlertButton" class="feeWarning" fill="clear" color="dark" @click="anchorPrograms.jitoTipWarning=false">
    ...
    <div class="flexCenterColumn feeWarning">
      <div class="noClickEvent">
        <ion-text color="dark" class="noClickEvent">Jito tip abnormally high</ion-text>
      </div>
