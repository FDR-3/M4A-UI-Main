<template>
  <div class="tableContainer">
    <DataTable 
      ...
      size="small" 
      :value="tableData"
      :globalFilterFields="['displayName', 'canidateAddress', 'contributionTotal', 'contributionTotalString', 'amountSpent']"
      ref="tableDownload" 
    ...
    >
      ...
      <Column field="canidateAddress" header="Unique Canidate Address" style="width: 40%" sortField="displayName" sortable>
        <template #body="slotProps">
          <div :class="props.searchAddress == slotProps.data.canidateAddress ? 'selfVoteBackground': ''">
            ...
            <div class="thinBorder chatTablePopupContainer">
              <div>
                <ion-label color="dark">Net Contribution To {{ event.canidateDisplayName }} From <span class="yellow">{{ displayName }}</span></ion-label><br>
...
<script setup lang="ts">
  ...
  {
    copyFullAddress(copyFullAddressButtonText, event.value.canidateAddress)
  }
  ...
  {
    localStorage.setItem("toggleVoterCanidateTable", "false")
