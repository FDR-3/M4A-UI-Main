<template>
  <div class="tableContainer">
    ...
    >
      ...
      <Column field="canidateAddress" header="Canidate Address" style="width: 40%" sortField="displayName" sortable>
      ...
      <Column field="voteAmount" header="Vote Amount" style="width: 0%" sortable>
        <template #body="slotProps">
          <ion-label v-if="slotProps.data.voteAmount.gt(new anchor.BN(0))" class="positive">{{ slotProps.data.voteAmountString }}</ion-label>
