    ...
    <div class="horizontalReply thickBorder smallMarginTop">
      ...
      <div class="flexCenterColumn middleContainer">
        ...
        <div v-if="connectedWallet.addressString==adminAccounts.chatCEOAddress" class="flexCenterRow">
          <div>
            <ion-button fill="clear" @click="isStarred ? unstarLv3Reply() : starLv3Reply()">
              <StarWolf id="ceoStarReplyButton" :fill="darkTheme.value ? '#FFFFFF' : '#000000'"/>
            </ion-button>
          </div>
          <div>
            <ion-button fill="clear" @click="isFed ? unFEDLv3Reply() : fedLv3Reply()">
...
<script setup lang="ts">
  ...
  function openPostInSolanaExplorer()
  {
    ...
    {
      const postPDA = getM4ALv3ReplyPDA(props.commentSectionNamePrefix, props.commentSectionName, props.chatAccountPostCountIndex, props.postOwnerAddress).toBase58()
      window.open(`https://explorer.solana.com/address/${postPDA}?cluster=devnet`, "_blank")
    }
    else if(navigation.menuIndex == MenuIndex.PLI)
    {
      const postPDA = getPLILv3ReplyPDA(props.commentSectionNamePrefix, props.commentSectionName, props.chatAccountPostCountIndex, props.postOwnerAddress).toBase58()
      window.open(`https://explorer.solana.com/address/${postPDA}?cluster=devnet`, "_blank")
    }
    else if(navigation.menuIndex == MenuIndex.About)
    {
      const postPDA = getAboutLv3ReplyPDA(props.commentSectionNamePrefix, props.commentSectionName, props.chatAccountPostCountIndex, props.postOwnerAddress).toBase58()
      window.open(`https://explorer.solana.com/address/${postPDA}?cluster=devnet`, "_blank")
    }
  }
  ...
  async function saveEdit()
  {
    ...
    try
    {
      if(navigation.menuIndex == MenuIndex.M4A)
      {
        contractFunctionName = "edit_m4a_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.editM4ALv3Reply(
      ...
      {
        contractFunctionName = "edit_pli_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.editPliLv3Reply(
        props.commentSectionNamePrefix, props.commentSectionName,
        props.chatAccountPostCountIndex,
        anchorPrograms.usdcFeeTokenAddress,
        editedMessage.value).rpc() 
      ...
      {
        contractFunctionName = "edit_about_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.editAboutLv3Reply(
        props.commentSectionNamePrefix, props.commentSectionName,
        props.chatAccountPostCountIndex,
        anchorPrograms.usdcFeeTokenAddress,
        editedMessage.value).rpc()
  ...
  async function postLv3Reply()
  {
    ...
    try
    {
      if(navigation.menuIndex == MenuIndex.M4A)
      {
        contractFunctionName = "reply_to_m4a_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.replyToM4ALv3Reply(
        props.commentSectionNamePrefix, props.commentSectionName,
      ...
      {
        contractFunctionName = "reply_to_pli_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.replyToPliLv3Reply(
        props.commentSectionNamePrefix, props.commentSectionName,
        props.postOwnerAddress,
        props.chatAccountPostCountIndex,
        anchorPrograms.usdcFeeTokenAddress,
      ...
      {
        contractFunctionName = "reply_to_about_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.replyToAboutLv3Reply(
        props.commentSectionNamePrefix, props.commentSectionName,
        props.postOwnerAddress,
        props.chatAccountPostCountIndex,
        anchorPrograms.usdcFeeTokenAddress,
  ...
  async function starLv3Reply()
  {
    ...
    try
    {
      if(navigation.menuIndex == MenuIndex.M4A)
      {
        contractFunctionName = "star_m4a_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.starM4ALv3Reply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
      ...
      {
        contractFunctionName = "star_pli_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.starPliLv3Reply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
      ...
      {
        contractFunctionName = "star_about_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.starAboutLv3Reply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
  ...
  async function fedLv3Reply()
  {
    ...
    try
    {
      if(navigation.menuIndex == MenuIndex.M4A)
      {
        contractFunctionName = "fed_m4a_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.fedM4ALv3Reply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
      ...
      {
        contractFunctionName = "fed_pli_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.fedPliLv3Reply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
      ...
      {
        contractFunctionName = "fed_about_reply_to_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.fedAboutLv3Reply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
