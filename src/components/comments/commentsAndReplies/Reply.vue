    ...
    <div class="horizontalReply thickBorder smallMarginTop">
      ...
      <div class="flexCenterColumn middleContainer">
        ...
        <div v-if="connectedWallet.addressString==adminAccounts.chatCEOAddress" class="flexCenterRow">
          <div>
            <ion-button fill="clear" @click="isStarred ? unstarReply() : starReply()">
              <StarWolf id="ceoStarReplyButton" :fill="darkTheme.value ? '#FFFFFF' : '#000000'"/>
            </ion-button>
          </div>
          <div>
            <ion-button fill="clear" @click="isFed ? unFEDReply() : fedReply()">
...
<script setup lang="ts">
  ...
  import ReplyLv3List from '/src/components/comments/commentsAndReplies/ReplyLv3List.vue'
  ...
  const repliesToReply = computed (() =>
  {
    var sortedRepliesToReply: any[] = []

    for(var i=0; i<props.repliesToReplies.length; i++)
    {
      if(props.repliesToReplies[i].account.parentId.eq(props.id))
        sortedRepliesToReply.push(props.repliesToReplies[i])
    }

    return sortedRepliesToReply.sort((a: any, b: any) => a.account.id.sub(b.account.id))
  })
  ...
  function openPostInSolanaExplorer()
  {
    ...
    {
      const postPDA = getM4AReplyPDA(props.commentSectionNamePrefix, props.commentSectionName, props.chatAccountPostCountIndex, props.postOwnerAddress).toBase58()
      window.open(`https://explorer.solana.com/address/${postPDA}?cluster=devnet`, "_blank")
    }
    else if(navigation.menuIndex == MenuIndex.PLI)
    {
      const postPDA = getPLIReplyPDA(props.commentSectionNamePrefix, props.commentSectionName, props.chatAccountPostCountIndex, props.postOwnerAddress).toBase58()
      window.open(`https://explorer.solana.com/address/${postPDA}?cluster=devnet`, "_blank")
    }
    else if(navigation.menuIndex == MenuIndex.About)
    {
      const postPDA = getAboutReplyPDA(props.commentSectionNamePrefix, props.commentSectionName, props.chatAccountPostCountIndex, props.postOwnerAddress).toBase58()
      window.open(`https://explorer.solana.com/address/${postPDA}?cluster=devnet`, "_blank")
    }
  }
  ...
  async function saveEdit()
  {
    ...
    try
    {
      if(navigation.menuIndex == MenuIndex.M4A)
      {
        contractFunctionName = "edit_m4a_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.editM4AReply(
      ...
      {
        contractFunctionName = "edit_pli_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.editPliReply(
        props.commentSectionNamePrefix, props.commentSectionName,
        props.chatAccountPostCountIndex,
        anchorPrograms.usdcFeeTokenAddress,
        editedMessage.value).rpc() 
      ...
      {
        contractFunctionName = "edit_about_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.editAboutReply(
        props.commentSectionNamePrefix, props.commentSectionName,
        props.chatAccountPostCountIndex,
        anchorPrograms.usdcFeeTokenAddress,
        editedMessage.value).rpc()
  ...
  async function postReply()
  {
    ...
    try
    {
      if(navigation.menuIndex == MenuIndex.M4A)
      {
        contractFunctionName = "reply_to_m4a_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.replyToM4AReply(
        props.commentSectionNamePrefix, props.commentSectionName,
      ...
      {
        contractFunctionName = "reply_to_pli_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.replyToPliReply(
        props.commentSectionNamePrefix, props.commentSectionName,
        props.postOwnerAddress,
        props.chatAccountPostCountIndex,
        anchorPrograms.usdcFeeTokenAddress,
      ...
      {
        contractFunctionName = "reply_to_about_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.replyToAboutReply(
        props.commentSectionNamePrefix, props.commentSectionName,
        props.postOwnerAddress,
        props.chatAccountPostCountIndex,
        anchorPrograms.usdcFeeTokenAddress,
  ...
  async function starReply()
  {
    ...
    try
    {
      if(navigation.menuIndex == MenuIndex.M4A)
      {
        contractFunctionName = "star_m4a_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.starM4AReply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
      ...
      {
        contractFunctionName = "star_pli_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.starPliReply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
      ...
      {
        contractFunctionName = "star_about_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.starAboutReply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
  ...
  async function fedReply()
  {
    ...
    try
    {
      if(navigation.menuIndex == MenuIndex.M4A)
      {
        contractFunctionName = "fed_m4a_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.fedM4AReply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
      ...
      {
        contractFunctionName = "fed_pli_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.fedPliReply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
      ...
      {
        contractFunctionName = "fed_about_reply"
        tx = await anchorPrograms.chat.chatProgram.methods.fedAboutReply
        (
          props.commentSectionNamePrefix, props.commentSectionName,
          props.postOwnerAddress,
          props.chatAccountPostCountIndex
