<template>
  <div>
    <h1>The Even More Obvious</h1>
    <div class="flexCenterRow">
      <PrevPageButton/>
      <div>
        <iframe class="videoContainer"
          src="https://www.youtube.com/embed/Ib_E5rqyBIg"
          allowfullscreen
          allowtransparency
        ></iframe>
      </div>
    ...
    <div class="sources">
      <h1>Sources</h1>
      <p align="left">Breezy Politic:<br>
        <a href="https://www.youtube.com/shorts/Ib_E5rqyBIg" target="_blank">Source</a><br>
      </p>
    </div>
  </div>
</template>
