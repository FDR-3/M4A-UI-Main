<template >
  ...
  <!--<div class="smallMarginTop mediumMarginBottom" >
    <ion-text id="AccessText" class="super rainbowText" >. T.Y.A.B.T.E.</ion-text>
  </div>-->
  <!--<ion-text id="AccessText" class="super">Visit m4a.io to learn more</ion-text>-->
</template>
