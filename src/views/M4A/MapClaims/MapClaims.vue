...
<script setup lang="ts">
  ...
  var stateApprovedClaimTotalString = ref()
  var stateApprovedClaimCount = ref()
  var stateDeniedClaimCount = ref()
  var stateUndeniedClaimCount = ref()
  var stateSubmittedAppealCount = ref()
  var stateDeniedAppealCount = ref()
  var stateRevokedApprovalCount = ref()
  var stateTotalHospitalCount = ref()
  var stateGeneralHospitalCount = ref()
  var stateDentalHospitalCount = ref()
  var stateVisionHospitalCount = ref()
  var stateMentalHospitalCount = ref()
