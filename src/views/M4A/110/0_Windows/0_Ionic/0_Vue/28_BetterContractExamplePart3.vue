<template>
  <div>
    <h1>Better Contract Example Part3 24/{{ totalPages }}</h1>
    <div class="flexCenterRow">
      <PrevPageButton/>
      <!--<media-player class="videoContainer" src="src/assets/video/M4A/110/28_1BetterContractExamplePart3/Better Contract Example Part3.mp4">
      ...
      <iframe class="videoContainer"
        src="https://www.youtube.com/embed/X7ahpWeGQ9Y?cc_load_policy=1&cc_lang_pref=en"
        allowfullscreen
      ></iframe>
      <NextPageButton/>
    </div>
