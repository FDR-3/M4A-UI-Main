  ...
  <div>
    ...
    <div class="flexCenterRow">
      ...
      <iframe class="videoContainer"
        src="https://www.youtube.com/embed/CbHuHqKdoNQ?cc_load_policy=1&cc_lang_pref=en"
        allowfullscreen
      ></iframe>
      <NextPageButton/>
    </div>
    ...
    <div class="sources">
      ...
      <p align="left">Links<br>
        <a href="https://docs.cypress.io/api/commands/click" target="_blank">Cypress Docs</a><br>
      </p>
    </div>
  </div>
</template>
