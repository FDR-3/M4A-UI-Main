<template>
  <div>
    <h1>NavBar 5/{{ totalPages }}</h1>
    <div class="flexCenterRow">
      <PrevPageButton/>
      <!--<media-player class="videoContainer" src="src/assets/video/M4A/110/8_1NavBar/NavBar.mp4">
      ...
      <iframe class="videoContainer"
        src="https://www.youtube.com/embed/GKm6XzfioXY?cc_load_policy=1&cc_lang_pref=en"
        allowfullscreen
      ></iframe>
      <NextPageButton/>
    </div>
