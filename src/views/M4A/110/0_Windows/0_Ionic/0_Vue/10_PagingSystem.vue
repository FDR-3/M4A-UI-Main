<template>
  <div>
    <h1>Paging System 7/{{ totalPages }}</h1>
    <div class="flexCenterRow">
      <PrevPageButton/>
      <!--<media-player class="videoContainer" src="src/assets/video/M4A/110/10_1PagingSystem/PagingSystem.mp4">
      ...
      <iframe class="videoContainer"
        src="https://www.youtube.com/embed/hpXOKwIRA00?cc_load_policy=1&cc_lang_pref=en"
        allowfullscreen
      ></iframe>
      <NextPageButton/>
    </div>
