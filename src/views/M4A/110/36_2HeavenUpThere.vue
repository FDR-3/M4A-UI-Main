<template>
  <div>
    <h1>Song: Heaven Up There</h1>
    <div class="flexCenterRow">
      <PrevPageButton/>
      <div>
        <iframe class="videoContainer"
          src="https://www.youtube.com/embed/V6D5vBzDu18"
          allowfullscreen
          allowtransparency
        ></iframe>
      </div>
    ...
    <div class="sources">
      ...
      <p align="left">Links<br>
        <a href="https://www.youtube.com/watch?v=V6D5vBzDu18" target="_blank">Artist: Palace</a><br>
      </p>
    </div>
  </div>
</template>
