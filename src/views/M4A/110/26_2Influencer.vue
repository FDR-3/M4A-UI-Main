<template>
  <div>
    <h1>How To Be The Best Influencer</h1>
    <div class="flexCenterRow">
      <PrevPageButton/>
      <div>
        <iframe class="videoContainer"
          src="https://www.youtube.com/embed/ksjzI-8Rz2w"
          allowfullscreen
          allowtransparency
        ></iframe>
      </div>
    ...
    <div class="sources">
      ...
      <p align="left">Links<br>
        <a href="https://www.youtube.com/watch?v=ksjzI-8Rz2w" target="_blank">Louis Rossmann</a><br>
      </p>
    </div>
  </div>
</template>
